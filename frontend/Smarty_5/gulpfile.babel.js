...
const Smarty = { 
  ...
  /** **************************************************************** **/
    ...
    imageminMozjpeg         : require('imagemin-mozjpeg').default,
    imageminSvgo            : require('imagemin-svgo').default,
...
Smarty.gulp.task('default', (cb) => {
  ...
  Smarty.clean.images([
          Smarty.settings.gulp_plugins.img_optimizer.output_folder
  ]);
  ...
  Smarty.utils.imageminRecursive(
      'src/images',
      Smarty.settings.gulp_plugins.img_optimizer.output_folder
  )
